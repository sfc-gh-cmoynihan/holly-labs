...
#   - Run this script from the Cortex Code terminal: ./create_automations.sh
#
# ============================================================================
...
echo "============================================"
echo "  Holly Labs — Creating Automations"
echo "============================================"
echo ""
...
echo "[1/5] Creating: tech-stock-tracker (weekdays 8am Dublin)"
...
End with: TECH_STOCK_TRACKER_OK"

echo "  ✓ tech-stock-tracker created"
echo ""
...
echo "[2/5] Creating: top-performers-chart (Mondays 9am Dublin)"
...
End with: TOP_PERFORMERS_CHART_OK"

echo "  ✓ top-performers-chart created"
echo ""
...
echo "[3/5] Creating: nvidia-price-check (weekdays 7am New York)"
...
End with: NVIDIA_PRICE_CHECK_OK"

echo "  ✓ nvidia-price-check created"
echo ""
...
echo "[4/5] Creating: msft-vs-googl-weekly (Mondays 8am Dublin)"
...
End with: MSFT_VS_GOOGL_OK"

echo "  ✓ msft-vs-googl-weekly created"
echo ""
...
echo "[5/5] Creating: fx-rate-alert (weekdays 7am Dublin)"
...
End with: FX_RATE_ALERT_OK"

echo "  ✓ fx-rate-alert created"
echo ""
...
echo "============================================"
echo "  All 5 automations created. Verifying..."
echo "============================================"
echo ""
...
echo ""
echo "============================================"
echo "  Done! Management commands:"
echo ""
echo "  cortex automation list                 # See all"
echo "  cortex automation doctor <name>        # Check health"
echo "  cortex automation suspend <name>       # Pause"
echo "  cortex automation resume <name>        # Resume"
echo "  cortex automation drop <name>          # Delete"
echo "============================================"

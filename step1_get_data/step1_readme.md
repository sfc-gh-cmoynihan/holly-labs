...
![Search for snowflake paid](images/1.png)

You should then select this one and click on **Try Now**.

![Select listing and click Try Now](images/2.png)

Type in your details.

![Enter your details](images/3.png)

Click on **Start trial**.

![Click Start trial](images/4.png)

Now it's ready to use. Click on **Query Data**.

![Query Data](images/5.png)
